...
### 3.HTML Tags
Markdown supports basic HTML for styling that Markdown syntax doesn’t cover, such as <sup> for superscript or <sub> for subscript.
H<sub>2</sub>O is the chemical formula for water.

Text Styling Tags
<strong> and <em>: Similar to bold (**text**) and italic (*text*) in Markdown, but allows for more consistent HTML styling.


<strong>Bold text</strong> and <em>italic text</em>
<u>: Underlines text, which isn’t available in Markdown.


<u>Underlined text</u>
<sup> and <sub>: Creates superscript and subscript, useful for scientific notations or footnotes.
